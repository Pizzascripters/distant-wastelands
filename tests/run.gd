...
const TEST_SCRIPTS: Array[String] = [
	...
	"res://tests/test_terrain_features.gd",
	...
	"res://tests/test_density.gd",
	"res://tests/test_ai_ranged.gd",
	"res://tests/test_perf.gd",
	"res://tests/test_spatial.gd",
	"res://tests/test_world_view.gd",
	"res://tests/test_gather_bar.gd",
	"res://tests/test_hud.gd",
	"res://tests/test_oxygen.gd",
	"res://tests/test_food.gd",
	"res://tests/test_building_panel.gd",
	"res://tests/test_research.gd",
	"res://tests/test_workshop.gd",
	"res://tests/test_medbay.gd",
	"res://tests/test_map_overlay.gd",
	"res://tests/test_radar.gd",
]
